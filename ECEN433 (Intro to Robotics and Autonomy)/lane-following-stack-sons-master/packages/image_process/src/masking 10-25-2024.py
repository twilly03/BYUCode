...
class Masking:
    ...
    def callback(self, image):
        ...
        # The new image should be half as tall as the input image and contain only the bottom half of the input image. 
        # This should remove most of the non-lane portion of the image. 
        # Feel free to experiment with the exact amount that you crop the image 
        # but leave a comment to justify if you choose something besides 50%.
